      ...
      <div class="my-5 row justify-content-center mx-0">
        <div class="col-lg-6 rounded bg-white shadow-sm p-4">
          ...
          <form @submit.prevent="payOrder">
            ...
            <!--paysuccess-->
            <div
              class="paysuccess d-flex justify-content-center align-items-center pb-4 my-5"
              v-if="order.is_paid"
            >
            ...
            <table class="table mb-5">
              <tbody>
                ...
                <tr>
                  <th>付款狀態</th>
                  <td>
                    <span v-if="!order.is_paid" class="text-funDarkOrange">尚未付款</span>
            ...
            <div class="text-right" v-if="order.is_paid === false">
              <router-link to="/home" class="btn btn-outline-secondary mr-4 px-4">取消</router-link>
              <button class="btn btn-funOrange text-light">確定付款</button>
            </div>
            <div class="text-center mb-5" v-if="order.is_paid === true">
              <router-link to="/home" class="btn btn-funOrange text-white px-4">回首頁</router-link>
            </div>
          </form>
        </div>
      </div>
